...
- https://github.com/tevsvet/api-gateway
...
- `compose/docker-compose.apps.yaml`
  `flow-manager`, `file-conversion-service` и их отдельные Postgres, API Gateway.
...
docker compose --env-file .env -f compose/docker-compose.apps.yaml logs -f api-gateway
